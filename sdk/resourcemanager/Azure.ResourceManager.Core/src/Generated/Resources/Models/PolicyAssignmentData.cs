...
namespace Azure.ResourceManager.Core
{
    ...
    public partial class PolicyAssignmentData : Resource<TenantResourceIdentifier>
    {
        ...
        internal PolicyAssignmentData(TenantResourceIdentifier id, string name, ResourceType type, string location, ResourceIdentity identity, string displayName, string policyDefinitionId, string scope, IList<string> notScopes, IDictionary<string, ParameterValuesValue> parameters, string description, object metadata, EnforcementMode? enforcementMode, IList<NonComplianceMessage> nonComplianceMessages) : base(id, name, type)
        {
            Location = location;
            Identity = identity;
