...
{
    public class GlossaryTest : GlossaryTestBase
    {
        public GlossaryTest(bool isAsync) : base(isAsync)
        {
        }
        ...
        {
            string categoryGuid = "19950dd2-4e89-45b1-be16-a82c45658e78";
            var client = GetGlossariesClient();
            Response fetchResponse = await client.GetCategoryTermsAsync(categoryGuid, new());
        ...
        {
            string glossaryGuid = "19950dd2-4e89-45b1-be16-a82c45658e78";
            var client = GetGlossariesClient();
            Response fetchResponse = await client.GetCategoryTermsAsync(glossaryGuid, new());
            Assert.AreEqual(200, fetchResponse.Status);
            JsonElement fetchBodyJson = JsonDocument.Parse(GetContentFromResponse(fetchResponse)).RootElement;
            Assert.GreaterOrEqual(fetchBodyJson.GetArrayLength(), 1);
        }
        ...
        public async Task GetRelatedCategories()
        {
            string categoryGuid = "19950dd2-4e89-45b1-be16-a82c45658e78";
            var client = GetGlossariesClient();
            Response fetchResponse = await client.GetRelatedCategoriesAsync(categoryGuid, new());
            Assert.AreEqual(200, fetchResponse.Status);
        }
        ...
        public async Task GetRelatedTerms()
        {
            ...
            var client = GetGlossariesClient();
            Response fetchResponse = await client.GetRelatedTermsAsync(termGuid, new());
            Assert.AreEqual(200, fetchResponse.Status);
            JsonElement fetchBodyJson = JsonDocument.Parse(GetContentFromResponse(fetchResponse)).RootElement;
        ...
        public async Task GetGlossaryTerms()
        {
            string termGuid = "26229cd6-0779-4d65-abee-f37a0d610a20";
            var client = GetGlossariesClient();
            Response fetchResponse = await client.GetGlossaryTermAsync(termGuid, new());
            Assert.AreEqual(200, fetchResponse.Status);
            JsonElement fetchBodyJson = JsonDocument.Parse(GetContentFromResponse(fetchResponse)).RootElement;
            Assert.GreaterOrEqual(fetchBodyJson.GetProperty("categories").GetArrayLength(), 1);
        }
        [RecordedTest]
        ...
        public async Task GetEntitesAssignedWithTerm()
        {
            string termGuid = "26229cd6-0779-4d65-abee-f37a0d610a20";
            var client = GetGlossariesClient();
            Response fetchResponse = await client.GetEntitiesAssignedWithTermAsync(termGuid, new());
            Assert.AreEqual(200, fetchResponse.Status);
            JsonElement fetchBodyJson = JsonDocument.Parse(GetContentFromResponse(fetchResponse)).RootElement;
            Assert.GreaterOrEqual(fetchBodyJson.GetArrayLength(), 1);
        }
        ...
        public async Task GetGlossaryTermsByGlossaryName()
        {
            ...
            var client = GetGlossariesClient();
            Response fetchResponse = await client.GetTermsByGlossaryNameAsync(glossaryName, new());
            Assert.AreEqual(200, fetchResponse.Status);
            JsonElement fetchBodyJson = JsonDocument.Parse(GetContentFromResponse(fetchResponse)).RootElement;
            Assert.GreaterOrEqual(fetchBodyJson.GetArrayLength(), 1);
        }
        ...
        {
            string glossaryGuid = "5a7916fe-3de0-4da8-ade7-2d5cb6e6a34e";
            var client = GetGlossariesClient();
            Response fetchResponse = await client.GetGlossaryTermHeadersAsync(glossaryGuid, new());
            Assert.AreEqual(200, fetchResponse.Status);
            JsonElement fetchBodyJson = JsonDocument.Parse(GetContentFromResponse(fetchResponse)).RootElement;
            Assert.GreaterOrEqual(fetchBodyJson.GetArrayLength(), 1);
        }
        ...
        public async Task GetGlossaryCategories()
        {
            string glossaryGuid = "5a7916fe-3de0-4da8-ade7-2d5cb6e6a34e";
            var client = GetGlossariesClient();
            Response fetchResponse = await client.GetGlossaryCategoriesAsync(glossaryGuid,new());
            Assert.AreEqual(200, fetchResponse.Status);
            JsonElement fetchBodyJson = JsonDocument.Parse(GetContentFromResponse(fetchResponse)).RootElement;
            Assert.GreaterOrEqual(fetchBodyJson.GetArrayLength(), 1);
        }
        ...
        public async Task GetGlossaryCategoriesHeaders()
        {
            string glossaryGuid = "5a7916fe-3de0-4da8-ade7-2d5cb6e6a34e";
            var client = GetGlossariesClient();
            Response fetchResponse = await client.GetGlossaryCategoriesHeadersAsync(glossaryGuid, new());
            Assert.AreEqual(200, fetchResponse.Status);
            JsonElement fetchBodyJson = JsonDocument.Parse(GetContentFromResponse(fetchResponse)).RootElement;
            Assert.GreaterOrEqual(fetchBodyJson.GetArrayLength(), 1);
        }
