...
{
    public class GlossaryTestBase : RecordedTestBase<PurviewCatalogTestEnvironment>
    {
        public GlossaryTestBase(bool isAsync) : base(isAsync)
        {
        }
        public GlossaryTestBase(bool isAsync, RecordedTestMode mode) : base(isAsync, mode)
        {
        }
