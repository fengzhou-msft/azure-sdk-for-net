...
{
    public class PurviewEntitiesTest : PurviewEntitiesTestBase
    {
        public PurviewEntitiesTest(bool isAsync) : base(isAsync)
        {
        }
        ...
        public async Task GetByGuid()
        {
            ...
            Response fetchResponse = await client.GetByGuidAsync("418522bd-3eb1-4b42-ba24-368e0214f677", new());
            ...
            Assert.AreEqual("s3://testpurview", fetchBodyJson.GetProperty("entity").GetProperty("attributes").GetProperty("qualifiedName").GetString());
        }
