...
{
    public class GlossariesTestBase : RecordedTestBase<PurviewCatalogTestEnvironment>
    {
        public GlossariesTestBase(bool isAsync) : base(isAsync)
        {
        }
        public GlossariesTestBase(bool isAsync, RecordedTestMode mode) : base(isAsync, mode)
        {
        }
