...
{
    public class EntitiesTestBase : RecordedTestBase<PurviewCatalogTestEnvironment>
    {
        public EntitiesTestBase(bool isAsync) : base(isAsync)
        {
        }
        public EntitiesTestBase(bool isAsync, RecordedTestMode mode) : base(isAsync, mode)
        {
        }
