...
namespace Azure.ResourceManager.ContainerService
{
    ...
    public partial class OSOptionProfileData : Resource
    {
        ...
        /// <param name="osOptionPropertyList"> The list of OS options. </param>
        internal OSOptionProfileData(ResourceIdentifier id, string name, ResourceType type, IReadOnlyList<OSOptionProperty> osOptionPropertyList) : base(id, name, type)
        {
