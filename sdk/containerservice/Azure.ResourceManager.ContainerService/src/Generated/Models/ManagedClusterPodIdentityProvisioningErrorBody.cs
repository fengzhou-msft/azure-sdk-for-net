...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ManagedClusterPodIdentityProvisioningErrorBody. </summary>
        ...
        internal ManagedClusterPodIdentityProvisioningErrorBody(string code, string message, string target, IReadOnlyList<ManagedClusterPodIdentityProvisioningErrorBody> details)
        {
            Code = code;
            Message = message;
            Target = target;
        ...
        public IReadOnlyList<ManagedClusterPodIdentityProvisioningErrorBody> Details { get; }
    }
}
