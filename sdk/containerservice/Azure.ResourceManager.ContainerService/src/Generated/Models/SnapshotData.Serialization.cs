...
namespace Azure.ResourceManager.ContainerService
{
    public partial class SnapshotData : IUtf8JsonSerializable
    {
        ...
        internal static SnapshotData DeserializeSnapshotData(JsonElement element)
        {
            ...
            return new SnapshotData(id, name, type, tags, location, systemData, creationData.Value, Optional.ToNullable(snapshotType), kubernetesVersion.Value, nodeImageVersion.Value, Optional.ToNullable(osType), Optional.ToNullable(osSku), vmSize.Value, Optional.ToNullable(enableFIPS));
        }
    }
}
