...
namespace Azure.ResourceManager.ContainerService
{
    public partial class ManagedClusterData : IUtf8JsonSerializable
    {
        ...
        internal static ManagedClusterData DeserializeManagedClusterData(JsonElement element)
        {
            ...
            Optional<IList<PrivateLinkResource>> privateLinkResources = default;
            ...
            return new ManagedClusterData(id, name, type, tags, location, sku.Value, extendedLocation.Value, identity, provisioningState.Value, powerState.Value, Optional.ToNullable(maxAgentPools), kubernetesVersion.Value, dnsPrefix.Value, fqdnSubdomain.Value, fqdn.Value, privateFQDN.Value, azurePortalFQDN.Value, Optional.ToList(agentPoolProfiles), linuxProfile.Value, windowsProfile.Value, servicePrincipalProfile.Value, Optional.ToDictionary(addonProfiles), podIdentityProfile.Value, nodeResourceGroup.Value, Optional.ToNullable(enableRBAC), Optional.ToNullable(enablePodSecurityPolicy), networkProfile.Value, aadProfile.Value, autoUpgradeProfile.Value, autoScalerProfile.Value, apiServerAccessProfile.Value, diskEncryptionSetID.Value, Optional.ToDictionary(identityProfile), Optional.ToList(privateLinkResources), Optional.ToNullable(disableLocalAccounts), httpProxyConfig.Value, securityProfile.Value, Optional.ToNullable(publicNetworkAccess));
        }
    }
}
