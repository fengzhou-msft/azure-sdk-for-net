...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class RunCommandResult
    {
        ...
        /// <param name="finishedAt"> The time when the command finished. </param>
        ...
        internal RunCommandResult(string id, string provisioningState, int? exitCode, DateTimeOffset? startedAt, DateTimeOffset? finishedAt, string logs, string reason)
        {
            Id = id;
