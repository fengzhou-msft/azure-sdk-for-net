...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class AgentPoolAvailableVersions : Resource
    {
        ...
        internal AgentPoolAvailableVersions(ResourceIdentifier id, string name, ResourceType type, IReadOnlyList<AgentPoolAvailableVersionsPropertiesAgentPoolVersionsItem> agentPoolVersions) : base(id, name, type)
        {
