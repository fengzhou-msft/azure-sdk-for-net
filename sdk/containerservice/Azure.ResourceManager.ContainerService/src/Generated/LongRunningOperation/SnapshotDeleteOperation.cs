...
namespace Azure.ResourceManager.ContainerService.Models
{
    ...
    public partial class SnapshotDeleteOperation : Operation
    {
        private readonly OperationOrResponseInternals _operation;

        /// <summary> Initializes a new instance of SnapshotDeleteOperation for mocking. </summary>
        protected SnapshotDeleteOperation()
        {
        }

        internal SnapshotDeleteOperation(Response response)
        {
