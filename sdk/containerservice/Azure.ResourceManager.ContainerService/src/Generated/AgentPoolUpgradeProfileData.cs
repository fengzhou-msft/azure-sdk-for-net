...
namespace Azure.ResourceManager.ContainerService
{
    ...
    public partial class AgentPoolUpgradeProfileData : Resource
    {
        ...
        internal AgentPoolUpgradeProfileData(ResourceIdentifier id, string name, ResourceType type, string kubernetesVersion, OSType osType, IReadOnlyList<AgentPoolUpgradeProfilePropertiesUpgradesItem> upgrades, string latestNodeImageVersion) : base(id, name, type)
        {
            KubernetesVersion = kubernetesVersion;
            OsType = osType;
            Upgrades = upgrades;
