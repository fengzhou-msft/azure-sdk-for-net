...
namespace Azure.ResourceManager.ContainerService
{
    ...
    public partial class ManagedClusterData : TrackedResource
    {
        /// <summary> Initializes a new instance of ManagedClusterData. </summary>
        /// <param name="location"> The location. </param>
        public ManagedClusterData(Location location) : base(location)
        {
            ...
            PrivateLinkResources = new ChangeTrackingList<PrivateLinkResource>();
        }
        ...
        internal ManagedClusterData(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, Location location, ManagedClusterSKU sku, ExtendedLocation extendedLocation, ResourceIdentity identity, string provisioningState, PowerState powerState, int? maxAgentPools, string kubernetesVersion, string dnsPrefix, string fqdnSubdomain, string fqdn, string privateFqdn, string azurePortalFqdn, IList<ManagedClusterAgentPoolProfile> agentPoolProfiles, ContainerServiceLinuxProfile linuxProfile, ManagedClusterWindowsProfile windowsProfile, ManagedClusterServicePrincipalProfile servicePrincipalProfile, IDictionary<string, ManagedClusterAddonProfile> addonProfiles, ManagedClusterPodIdentityProfile podIdentityProfile, string nodeResourceGroup, bool? enableRbac, bool? enablePodSecurityPolicy, ContainerServiceNetworkProfile networkProfile, ManagedClusterAADProfile aadProfile, ManagedClusterAutoUpgradeProfile autoUpgradeProfile, ManagedClusterPropertiesAutoScalerProfile autoScalerProfile, ManagedClusterAPIServerAccessProfile apiServerAccessProfile, string diskEncryptionSetID, IDictionary<string, Models.UserAssignedIdentity> identityProfile, IList<PrivateLinkResource> privateLinkResources, bool? disableLocalAccounts, ManagedClusterHttpProxyConfig httpProxyConfig, ManagedClusterSecurityProfile securityProfile, PublicNetworkAccess? publicNetworkAccess) : base(id, name, type, tags, location)
        {
            Sku = sku;
        ...
        public IList<PrivateLinkResource> PrivateLinkResources { get; }
